...
import static com.codeaffine.home.control.status.internal.activation.Messages.ZONE_ACTIVATION_STATUS_CHANGED_INFO;
import static com.codeaffine.home.control.status.internal.activation.ZoneUtil.markForInPathRelease;
...
public class ActivationSupplierImpl implements ActivationSupplier {
    ...
    AdjacencyDefinition adjacencyDefinition, EventBus eventBus, Logger logger, ActivationSupplierPreference preference )
  {
    ...
    this.core = new StatusSupplierCore<>( eventBus, new Activation( emptySet() ), this, logger );
  ...
  @Subscribe
  public void engagedZonesChanged( ActivationEvent event ) {
