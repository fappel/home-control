...
import static com.codeaffine.home.control.engine.preference.PreferenceModelImplTest.MyEnum.*;
...
public class PreferenceModelImplTest {
  ...
  private static final String DEFALULT_LIST_VALUE = "{ONE, ONE}";
  ...
  interface MyPreference {
    ...
    @DefaultValue( DEFALULT_LIST_VALUE )
    List<MyEnum> getList();
  ...
  public void setUp() {
    ...
    preferenceModel = new PreferenceModelImpl( eventBus );
  }
  ...
  public void saveAndLoad() {
    ...
    PreferenceModelImpl otherModel = new PreferenceModelImpl( eventBus );
    otherModel.load( in );
