...
package com.codeaffine.home.control.admin.ui.internal.property;
...
public class PropertySheetViewer extends Viewer {
  ...
  // The input objects for the viewer
	 ...
	 */
	private final HashMap entryToItemMap = new HashMap();

	private final TreeEditor treeEditor;

	private static String[] columnLabels = { "Attribute", "Value" };
	...
	private final ListenerList activationListeners = new ListenerList();
